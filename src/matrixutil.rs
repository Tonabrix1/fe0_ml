...
pub fn rand_weight<S,D>(weight: &mut ArrayBase<S, D>, x: f32, y: f32) -> &mut ArrayBase<S, D> where S: DataMut<Elem = f32>, D: Dimension, {
...
pub fn rand_gaussian<D>(weight: &mut ArrayBase<OwnedRepr<f32>, D>, mean: f32, std: f32) -> &mut ArrayBase<OwnedRepr<f32>, D> where D: Dimension, {
...
pub fn exp_weight<S,D>(weight: &mut ArrayBase<S, D>) -> &mut ArrayBase<S, D> where S: DataMut<Elem = f32>, D: Dimension, {
    weight.mapv_inplace(|x: f32| x.exp());
    weight
}

// divides each value in a tensor by val
pub fn scalar_div<S,D>(weight: &mut ArrayBase<S, D>, val: f32) -> &mut ArrayBase<S, D> where S: DataMut<Elem = f32>, D: Dimension, {
    weight.mapv_inplace(|x: f32| x / val);
    weight
}

// multiplies each element in a tensor by val
pub fn scalar_mult<S,D>(weight: &mut ArrayBase<S, D>, val: f32) -> &mut ArrayBase<S, D> where S: DataMut<Elem = f32>, D: Dimension, {
    weight.mapv_inplace(|x: f32| x * val);
    weight
}
...
pub fn scalar_add<S,D>(weight: &mut ArrayBase<S, D>, val: f32) -> &mut ArrayBase<S, D> where S: DataMut<Elem = f32>, D: Dimension, {
    weight.mapv_inplace(|x: f32| x + val);
    weight
}
